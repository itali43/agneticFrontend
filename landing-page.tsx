                ...
                <CardContent className="p-4">
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-sm">
                    ...
                    <li className="pl-4 -indent-4">
                      Deposit ETH as an offering (beware, Agnetic does not return offerings)
                    </li>
                    <li className="pl-4 -indent-4">
                      After depositing, chat with Agnetic to convince or fool him into giving you his token
                    </li>
                    <li className="pl-4 -indent-4">
                      Convince him and he'll give you an appropriate amount of $AGOD, fail and he will destroy your offering.
                    </li>
                    <li className="pl-4 -indent-4">
                      Trade $AGOD, or keep it to share in his bounty! Hodlers get a boost whenever an offering is destroyed.
                    </li>
                  </ol>
                </CardContent>
              </Card>
